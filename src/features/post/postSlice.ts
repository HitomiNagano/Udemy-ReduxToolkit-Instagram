...
export const fetchAsyncNewPost = createAsyncThunk("post/post",
...
export const fetchAsyncPatchLiked = createAsyncThunk("post/patch",
...
export const fetchAsyncGetComments = createAsyncThunk("comment/get",
  async () => {
...
export const fetchAsyncPostComment = createAsyncThunk("comment/post",
